          ...
          <div v-else-if="activeTab === 'debug'" key="debug" class="settings-body">
            ...
            <div class="setting-item setting-item-vertical">
              <div class="debug-section-header">
                ...
                <button class="debug-icon-btn" @click="refreshDebugInfo" title="Refresh">&#x21bb;</button>
              </div>
...
import { useDebugInfo, type DebugStorageInfo, type DebugBrowserInfo } from '@/composables/useDebugInfo'
...
const { logBuffer, isCapturing, startCapture, stopCapture, clearLogs, gatherStorageInfo, gatherBrowserInfo } = useDebugInfo()
